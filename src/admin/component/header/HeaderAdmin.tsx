    ...
    <header className="h-20 bg-white border-b border-gray-100 px-8 flex items-center justify-between sticky top-0 z-10">
      ...
      <div className="flex items-center space-x-6">
        <div className="hidden lg:block border-r pr-6 border-gray-100">
          <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Hệ thống</span>
        ...
        <div className="flex items-center gap-3 pl-2 cursor-pointer group">
          ...
          <div className="relative">
            <div className="w-11 h-11 rounded-xl bg-emerald-500 flex items-center justify-center text-white font-bold shadow-lg shadow-emerald-200 ring-2 ring-white overflow-hidden">
              <img 
                src="https://ui-avatars.com/api/?name=Viet+Stay&background=eab308&color=fff" 
                alt="avatar" 
              />
            </div>
