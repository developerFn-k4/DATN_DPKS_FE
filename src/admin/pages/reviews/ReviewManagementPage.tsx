...
import type { Review, ReviewDetail } from "../../services/reviewService";
  ...
  const columns: ColumnsType<Review> = [
    ...
    },
    {
      ...
      render: (customer: string) => (
        <p className="font-medium text-slate-800 text-sm">{customer}</p>
      ),
    },
    {
      title: "Đánh giá",
      ...
      >
        {detailLoading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-slate-50 rounded-lg">
              <p className="text-sm text-slate-500 mb-3">Chi tiết đánh giá</p>
            ...
            <div className="p-4 bg-slate-50 rounded-lg">
              ...
              <p className="text-slate-700 leading-relaxed">{selectedReviewDetail.comment}</p>
            </div>

            <div className="p-4 bg-slate-50 rounded-lg">
              <p className="text-sm text-slate-500 mb-2">Thông tin đặt phòng</p>
