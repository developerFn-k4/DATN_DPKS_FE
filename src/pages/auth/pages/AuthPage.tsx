            ...
            <div className="hidden lg:flex">
              <div className="w-full rounded-3xl border border-white/60 bg-white/40 p-10 shadow-[0_10px_30px_rgba(0,0,0,0.08)] backdrop-blur-xl">
                ...
                <p className="mt-3 text-slate-700">
                  Đặt phòng nhanh • Ưu đãi theo mùa • Trải nghiệm tươi mới như
                  mùa xuân.
                </p>
                ...
                <div className="mt-10 rounded-2xl bg-gradient-to-r from-emerald-600 to-sky-500 p-5 text-white">
                  ...
                  <div className="mt-1 text-sm opacity-95">
                    Đăng nhập để xem giá tốt nhất theo ngày và nhận ưu đãi mùa
                    xuân 🌿
                  </div>
                </div>
              </div>
                          ...
                          >
                            ...
                            <div className="mb-4 flex items-center justify-between">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  msg.info(
                                    "Demo: bạn có thể mở modal Quên mật khẩu",
                                  )
                                }
                              >
                                Quên mật khẩu?
                            ...
                            <Divider className="my-5 text-slate-400">
                              hoặc
                            </Divider>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <Button
                                className="rounded-xl"
                                onClick={() => msg.info("Demo: Google SSO")}
                              >
                                Google
                              </Button>
                              <Button
                                className="rounded-xl"
                                onClick={() => msg.info("Demo: Facebook SSO")}
                              >
                                Facebook
                              </Button>
                            </div>
